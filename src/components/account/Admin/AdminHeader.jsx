...
const AdminHeader = () => {
  ...
  return (
    <div className="relative bg-primary flex items-center justify-between p-4 text-white">
        ...
        <div className="absolute top-0 right-2 mt-2 w-48 bg-white text-black rounded shadow-lg z-50">
          ...
          <div className="pt-10">
            {menuItems.map((item, index) => (
              <div key={index} onClick={() => handleRouting(item)} title={item.text} className="px-4 py-1 hover:bg-secondary hover:text-white cursor-pointer">
